...
<style>
  .correndo {
    ...
    background: url('https://raw.githubusercontent.com/innng/innng/master/assets/kyubey.gif') repeat-x; /* URL da imagem e repetição horizontal */
    animation: correndo 4s linear infinite; /* animação com duração de 4 segundos e repetição infinita */
  }

  @keyframes correndo {
    0% { background-position: 0 0; } /* posição inicial da imagem */
    100% { background-position: 100% 0; } /* posição final da imagem */
  }
</style>

<p align="center">
  <div class="correndo"></div>
</p>
